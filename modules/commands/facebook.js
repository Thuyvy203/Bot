...
if (!args[0]) return api.sendMessage({body:`== [ FACEBOOK ] ==\n━━━━━━━━━━━━\n→ Cách sử dụng\n→ facebook video + link\n→ facebook music + link
...
var url = res.audio;
var time = res.time;
       var callback = () => api.sendMessage({body:`Thời lượng: ${time}`}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/musicfb.mp3"),event.messageID);
